...
//if HTTPS status is >=300, throw error
...
fetch(url)
    ...
    .catch(error => {
        ...
        document.querySelector(".section.general-section").innerHTML = "";
        header_text_element.innerHTML = "Oops, there was a network error. Please try again later.";
        document.querySelector(".loading-screen").style.display = "none";
        //alert(error);
    })
